...
var fudongDiv = {
		...
		inputBox:function(obj)   
		{
			...
			this.content += "<a onclick='fudongDiv.ShowClick(this)' onmouseover=\"this.style.background='#999'\" onmouseout=\"this.style.background=''\">"+contentCopy+"</a><br/>"; 
			...
			this.content += "<a onclick='fudongDiv.ShowClick(this)' onmouseover=\"this.style.background='#999'\" onmouseout=\"this.style.background=''\" onblur=\"javascript:fudongDiv.CloseBox()\">"+contentCopy+"</a><br/>";    
			contentCopy=content+"@fudan.edu.cn";
			this.content += "<a onclick='fudongDiv.ShowClick(this)' onmouseover=\"this.style.background='#999'\" onmouseout=\"this.style.background=''\">"+contentCopy+"</a><br/>";   
			this.g("showUser").style.display="block"; 
			this.g("showUser").style.background="#A0C9E9";
			this.g("showUser")['style']['left']=(parseInt(obj.offsetLeft)+80)+"px";    
			this.g("showUser")['style']['top']=(parseInt(obj.offsetTop)+90)+"px";
			
			this.g("showUser").innerHTML = this.content+"<p align='right'><a href='javascript:fudongDiv.CloseBox()'>Close</a></p>"; 
